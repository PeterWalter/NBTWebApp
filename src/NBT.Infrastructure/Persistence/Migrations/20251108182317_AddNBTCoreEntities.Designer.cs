...
namespace NBT.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251108182317_AddNBTCoreEntities")]
    partial class AddNBTCoreEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NBT.Domain.Entities.RoomAllocation", b =>
                {
                    ...
                    b.Property<int>("AllocatedStudents")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.HasIndex("TestSessionId", "RoomId")
                        .IsUnique()
                        .HasDatabaseName("IX_RoomAllocations_SessionRoom");
